...
def resample_along_rays(origins, directions, radii, t_samples, weights, randomized, ray_shape, stop_grad, resample_padding):
    """Resampling.
    Args:
        origins: torch.Tensor, [batch_size, 3], ray origins.
        directions: torch.Tensor, [batch_size, 3], ray directions.
...
def rearrange_render_image(rays, chunk_size=4096):
    # for validation rays
    # change Rays to list: [origins, directions, viewdirs, radii, near, far]
